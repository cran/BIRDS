...
## ----monthly and plot, echo=TRUE, fig.height=5, fig.width=9, message=FALSE, warning=FALSE----
...
## ----completting2, echo=TRUE, fig.height=5, fig.width=9, message=FALSE, warning=FALSE----
